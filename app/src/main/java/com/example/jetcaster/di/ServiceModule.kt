...
object ServiceModule {
    ...
    @Provides
    @ServiceScoped
    fun provideOkHttpDataSourceFactory(okHttpClient: OkHttpClient, @ApplicationContext context: Context): OkHttpDataSource.Factory {

        return OkHttpDataSource.Factory(okHttpClient).setUserAgent(Util.getUserAgent(context, context.packageName))
    }
