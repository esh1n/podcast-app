package com.example.jetcaster.data.exoplayer
    ...
    fun setEpisodes(data: List<Episode>) {
        ...
        mediaMetadataEpisodes = data.map { episode ->
            MediaMetadataCompat.Builder()
                .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_ID, episode.uri)
                .putString(
                ...
                .putString(MediaMetadataCompat.METADATA_KEY_MEDIA_URI, episode.mediaUri)
                .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI, episode.uri)
                .build()
        }
